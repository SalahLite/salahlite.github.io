...
const translations = {
  en: {
    ...
    site: {
      ...
      language: "Language",
      appStoreLink: "itms-apps://apps.apple.com/us/app/salah-lite/id6763838391"
    },
    features: [
      {
        icon: "clock",
  ...
  zh: {
    ...
    site: {
      ...
      ctaTitle: "安心礼拜，从这里开始",
      language: "语言",
      appStoreLink: "itms-apps://apps.apple.com/cn/app/salah-lite/id6763838391"
    },
    features: [
      {
        icon: "clock",
  ...
  ar: {
    ...
    site: {
      ...
      language: "اللغة",
      appStoreLink: "itms-apps://apps.apple.com/sa/app/salah-lite/id6763838391"
    },
    features: [
      {
        icon: "clock",
